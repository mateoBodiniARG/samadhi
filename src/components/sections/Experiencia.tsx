                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {pillars.map((p, i) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            variants={fadeUp}
                            className="group relative rounded-3xl p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-xl"
                            style={{
                                background: "#ffffff",
                        ...
                        >
                            ...
                            {/* Bottom accent line */}
                            <div
                                className="mx-auto mt-6 h-0.5 w-12 rounded-full opacity-0 transition-opacity duration-300 group-hover:opacity-100"
